...
export default function StoryViewer({ groups, initialGroupIndex, onClose, onAuthorClick }: Props) {
  ...
  return createPortal(
    ...
    >
      ...
      <div style={{
        ...
        <div
          ...
          style={{
            ...
            border: "2.5px solid #22C55E", overflow: "hidden",
            background: authorBg,
        ...
        {/* Name + time */}
        <div
          style={{ flex: 1, minWidth: 0, cursor: onAuthorClick ? "pointer" : "default" }}
          onClick={e => { e.stopPropagation(); onAuthorClick?.(group.authorId); }}
        >
      ...
      {/* ── STORY TEXT/EMOJI (overlaid on photo) ── */}
      {(story.content || story.emoji) && (
        <div style={{
          position: "absolute", top: 100, left: 0, right: 0, zIndex: 8,
          display: "flex", justifyContent: "flex-start",
          padding: "0 14px",
        }}>
          {story.emoji && (
            <span style={{
              fontSize: 28, marginRight: story.content ? 8 : 0,
          ...
          {story.content && (
            <span style={{
              ...
              background: story.mediaUrl ? "rgba(0,0,0,0.32)" : "transparent",
              borderRadius: story.mediaUrl ? 10 : 0,
              padding: story.mediaUrl ? "4px 10px" : 0,
            }}>{story.content}</span>
          )}
        </div>
      )}
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
          ...
          <div
            onClick={e => e.stopPropagation()}
            style={{
              flex: 1, height: 38, borderRadius: 22,
          ...
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill={liked ? "#22C55E" : "none"}>
              <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"
                stroke={liked ? "#22C55E" : "rgba(255,255,255,0.9)"} strokeWidth="1.6"/>
            </svg>
      ...
      <style>{`
        .bp-story-reply::placeholder { color: rgba(255,255,255,0.62); }
      `}</style>
