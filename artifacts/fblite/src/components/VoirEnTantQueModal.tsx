  ...
  return createPortal(
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.65)", zIndex: 200, overflowY: "auto" }}>
      ...
      <div style={{ maxWidth: 600, margin: "0 auto", minHeight: "100vh", background: "#F8FAFC", position: "relative", animation: "vtqSlideUp 0.22s ease-out", fontFamily: "-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif" }}>
        ...
        {/* ── INFO BANNER ── */}
        <div style={{ background: "#F0FDF4", borderLeft: "4px solid #22C55E", padding: "10px 16px", fontSize: 13, color: "#16A34A", fontWeight: 600, display: "flex", alignItems: "center", gap: 8 }}>
        ...
        <div style={{ position: "relative" }}>
          <div style={{ height: 195, position: "relative", overflow: "hidden" }}>
            <svg viewBox="0 0 480 195" preserveAspectRatio="xMidYMid slice" style={{ position: "absolute", inset: 0, width: "100%", height: "100%" }}>
              ...
              <path d="M-10 78 C 100 28, 185 118, 285 68 S 415 18, 510 52" stroke="#22C55E" strokeOpacity="0.14" strokeWidth="1.2" fill="none"/>
        ...
        <div style={{ background: "#fff", paddingTop: 62, borderBottom: "1px solid #F1F5F9" }}>
          <div style={{ padding: "0 16px 18px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 7, flexWrap: "wrap", marginBottom: 3 }}>
              <span style={{ fontWeight: 900, fontSize: 22, color: "#111827", letterSpacing: -0.3 }}>{userName}</span>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginBottom: 14 }}>
                {badges.map((badge, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "center", gap: 4, background: "#F0FDF4", border: "1px solid #DCFCE7", borderRadius: 20, padding: "4px 10px" }}>
                    ...
                    <span style={{ fontSize: 12, fontWeight: 600, color: "#16A34A" }}>{badge.label}</span>
                  </div>
                ))}
              </div>
            )}
            ...
            <div style={{ display: "flex", paddingTop: 14, borderTop: "1px solid #F1F5F9", marginTop: 4 }}>
              {stats.map((stat, i) => (
                <div key={i} style={{ flex: 1, textAlign: "center", borderRight: i < 3 ? "1px solid #F1F5F9" : "none", padding: "2px 4px" }}>
                  ...
                  <div style={{ fontWeight: 900, fontSize: 17, color: "#111827", lineHeight: 1.15 }}>{stat.value}</div>
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 16 }}>
              ...
              <div style={{ flex: 1, padding: "12px 6px", background: "#fff", color: "#64748B", border: "1.5px solid #E5E7EB", borderRadius: 14, fontWeight: 700, fontSize: 13, display: "flex", alignItems: "center", justifyContent: "center", gap: 5 }}>
          ...
          <div className="vtq-tabs" style={{ display: "flex", overflowX: "auto", scrollbarWidth: "none", borderTop: "1px solid #F1F5F9" }}>
            {["Publications", "Photos", "Vidéos", "Amis", "À propos"].map((t, i) => (
              <button key={t} style={{ flex: "0 0 auto", padding: "13px 16px", background: "none", border: "none", cursor: "default", fontSize: 13, fontWeight: i === 0 ? 800 : 500, color: i === 0 ? "#22C55E" : "#94A3B8", borderBottom: i === 0 ? "2.5px solid #22C55E" : "2.5px solid transparent", whiteSpace: "nowrap" }}>
                {t}
              </button>
            ))}
          </div>
          ...
          <div style={{ background: "#fff", borderRadius: 22, padding: "32px 20px 28px", textAlign: "center", boxShadow: "0 2px 12px rgba(0,0,0,0.06)", border: "1px solid rgba(34,197,94,0.07)" }}>
            <div style={{ marginBottom: 18, display: "flex", justifyContent: "center" }}>
              <svg width="100" height="110" viewBox="0 0 100 110" fill="none">
                ...
                <path d="M27 98 Q 14 76 32 65 Q 28 84 44 95Z" fill="#22C55E" opacity="0.45"/>
                <path d="M73 98 Q 86 76 68 65 Q 72 84 56 95Z" fill="#22C55E" opacity="0.45"/>
            ...
            <div style={{ fontWeight: 900, fontSize: 17, color: "#111827", marginBottom: 8 }}>Publications visibles par vos amis uniquement</div>
