...
export default function Messages({ initialUserId }: { initialUserId?: number }) {
  ...
  if (sig.callState === "incoming" && sig.incomingCall) {
    ...
    return (
      <div style={{ position: "fixed", inset: 0, zIndex: 10000, background: "linear-gradient(160deg, #0d1b2a 0%, #1a3a52 100%)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "48px 32px" }}>
