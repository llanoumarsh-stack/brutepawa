...
export default function MessagingSettingsPage() {
  ...
  const ROWS = [
    { bg:"linear-gradient(135deg,#B45309,#F59E0B)", icon:<svg width="20" height="20" viewBox="0 0 24 24" {...sv}><path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 01-3.46 0"/></svg>, title:"Notifications de messages", sub:"Personnalisez vos notifications", path:"/settings/messaging/notifications" },
    { bg:"linear-gradient(135deg,#0E7490,#06B6D4)", icon:<svg width="20" height="20" viewBox="0 0 24 24" {...sv}><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>, title:"Invitations", sub:"Gérez vos invitations reçues", path:"/settings/messaging/requests" },
    { bg:"linear-gradient(135deg,#15803D,#22C55E)", icon:<svg width="20" height="20" viewBox="0 0 24 24" {...sv}><polyline points="21,8 21,21 3,21 3,8"/><rect x="1" y="3" width="22" height="5"/></svg>, title:"Archive", sub:"Gérez vos conversations archivées", path:"/settings/messaging/archive" },
    ...
    { bg:"linear-gradient(135deg,#1D4ED8,#3B82F6)", icon:<svg width="20" height="20" viewBox="0 0 24 24" {...sv}><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><polyline points="7,10 12,15 17,10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>, title:"Téléchargement automatique", sub:"Photos, vidéos, fichiers", path:"/settings/messaging/download" },
    ...
    { bg:"linear-gradient(135deg,#475569,#64748B)", icon:<svg width="20" height="20" viewBox="0 0 24 24" {...sv}><circle cx="12" cy="12" r="3"/><path d="M19.07 4.93l-1.41 1.41M5.34 17.66l-1.41 1.41M2 12H3M21 12h1M17.66 5.34l1.41 1.41M4.93 19.07l1.41 1.41M12 2v1M12 21v1"/></svg>, title:"Paramètres avancés", sub:"Plus d'options de messagerie", path:"/settings/messaging/advanced" },
  ];
      ...
      <div style={{ padding:"14px 14px 0" }}>
        ...
        <div style={{ background:C.card,borderRadius:24,boxShadow:C.shadow,padding:"16px",display:"flex",alignItems:"center",gap:14,marginBottom:12 }}>
          {user.avatarUrl
            ...
            : <div style={{ width:60,height:60,borderRadius:"50%",background:"linear-gradient(135deg,#22C55E,#15803D)",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,border:"2px solid #fff",boxShadow:"0 2px 8px rgba(34,197,94,0.3)" }}><span style={{ fontSize:24,fontWeight:800,color:"#fff" }}>{name.charAt(0).toUpperCase()}</span></div>}
          <div style={{ flex:1 }}>
            <div style={{ display:"flex",alignItems:"center",gap:6,flexWrap:"wrap" }}>
              <span style={{ fontWeight:700,fontSize:16,color:C.text }}>{name}</span>
              <svg width="16" height="16" viewBox="0 0 24 24"><path d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" fill="#3B82F6"/><path d="M9 12l2 2 4-4" stroke="#fff" strokeWidth="2" strokeLinecap="round"/></svg>
