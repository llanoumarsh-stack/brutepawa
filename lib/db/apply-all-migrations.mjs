  ...
  for (const stmt of statements) {
    try {
      ...
      if (
        ...
        err.code === "23505" || // unique_violation (constraint already enforced)
        ...
        await client.end();
        // Fail hard: a broken migration must abort the deployment,
        // otherwise the API can start against an incomplete schema.
        process.exit(1);
      }
    }
  }
